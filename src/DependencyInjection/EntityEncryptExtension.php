<?php
namespace OSW3\EntityEncrypt\DependencyInjection;
...
class EntityEncryptExtension extends Extension implements PrependExtensionInterface 
{
	/**
	...
	public function prepend(ContainerBuilder $container)
    {
        ...
        // $twigConfig = [];
		// $this->extendsTwigConfig($twigConfig, Path::join(__DIR__, "/../../", "templates"), "EntityEncrypt");
